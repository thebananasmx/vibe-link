...
import type { BentoItemData, VibeConfig } from '../types';
...
const EditorScreen: React.FC<EditorScreenProps> = ({ vibeConfig, user, onShuffle, onUpdateItem, onUpdateConfig }) => {
  const [editingItem, setEditingItem] = useState<BentoItemData | null>(null);
  const [saveState, setSaveState] = useState<SaveState>('idle');

  if (!vibeConfig) return <CircleLoader />;
