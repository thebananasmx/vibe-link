  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-full bg-[#F5EFE6] text-[#1E1E1E] p-4">
      <div className="text-center max-w-2xl w-full">
        <h1 className="text-5xl md:text-7xl font-bold mb-4" dangerouslySetInnerHTML={{ __html: t('inputScreen.title') }} />
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 items-center justify-center">
          <input
            ...
            placeholder={t('inputScreen.placeholder')}
            ...
            aria-label={t('inputScreen.ariaLabel')}
          />
          <button
            type="submit"
          ...
          >
            {t('inputScreen.button')} <Sparkles size={20} />
          </button>
        </form>
      </div>
    </div>
