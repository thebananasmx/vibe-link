      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
        {user ? (
          ...
          <>
            <motion.button
              onClick={onPublish}
              className="flex items-center justify-center gap-2 px-8 py-4 bg-[#8ECAE6] text-black font-bold text-lg rounded-xl border-2 border-black shadow-[4px_4px_0px_#000] hover:shadow-[6px_6px_0px_#000] active:shadow-[2px_2px_0px_#000] transform active:translate-x-[2px] active:translate-y-[2px] transition-all duration-200"
              aria-label="Publish your VibeLink"
